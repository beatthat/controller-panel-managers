...
#pragma warning restore 618
        ...
        public Component FindPanel(Type pType)
        {
            ...
            {
                Debug.LogWarning("Failed to find a managed panel of type '"
                    + pType.Name + "'. If you have multiple panel managers and want to allow this,"
                    + " set property ignoreUnmanagedPanels true on " + this.Path());
            }
#endif
            return null;
        }
